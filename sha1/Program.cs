    ...
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            else
            {
                ...
                CmdLineAppArgs parsedArgs = CmdLineAppUtils.ParseCmdLineArgs(args, Hashes.SHA1);
                ...
                if (parsedArgs != null)
                {
                    ...
                    if (CmdLineAppUtils.PerformHashes(parsedArgs, true, Hashes.SHA1)) return 0;
        ...
        static void Usage()
        {
            ...
            Console.WriteLine("Usage: sha1 [-base64|-hexcaps|-bubbab] [-compare] [-out outfile [-append]]");
            ...
            Console.WriteLine();
            Console.WriteLine("In hashing mode, WinHasher computes the SHA-1 hash of the given file(s) and");
