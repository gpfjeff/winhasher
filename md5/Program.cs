...
namespace com.gpfcomics.WinHasher.md5console
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else if (args.Length == 1)
            {
                ...
                try
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine(HashEngine.MD5HashFile(args[0]));
                }
        ...
        static void Usage()
        {
            ...
            Console.WriteLine("To use WinHasher MD5, feed it one more more paths to files.  If the file");
            Console.WriteLine("path contains spaces, make sure to enclose the entire path in quotes.");
            Console.WriteLine("If only one file is specified, its MD5 hash will be returned.  If more");
            Console.WriteLine("than one file is specified, the MD5 hash of each file will be computed");
